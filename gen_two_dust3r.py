...
view_path = "/home/yugrp01/Downloads/instantsplat_train_test_split/collated_instantsplat_data/eval/self/mini"

view_1_path = os.path.join(view_path, "9_views_1")
view_2_path = os.path.join(view_path, "9_views_2")
...
view_total_path = os.path.join(view_path, "17_views")
