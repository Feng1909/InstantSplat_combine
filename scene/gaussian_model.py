...
class GaussianModel:
    ...
    def save_ply(self, path):
        ...
        # # elements = np.empty(10000, dtype=dtype_full)
        # # print("xyz: ", xyz.shape)
        ...
        # # print(np.min(scale))
        # # attributes = attributes[:10000, :]
        # xyz_point = xyz.tolist()
        # sum = 0
        # xyz_new = []
        # normals_new = []
        # f_dc_new = []
        ...
        # scale_new = []
        # rotation_new = []
        # print(max(xyz[:, 2]), min(xyz[:, 2]))
        # import math
        # for i in range(len(xyz_point)-1):
        #     # if math.sqrt((xyz_point[i][0]-xyz_point[i+1][0])**2 \
        #     #             +(xyz_point[i][1]-xyz_point[i+1][1])**2 \
        #     #             +(xyz_point[i][2]-xyz_point[i+1][2])**2) < 0.001:
        #     # if opacities[i] > 0.5:
        #     if min(scale[i]) < -7:
        #     # if True:
        #         sum += 1
        ...
        #         #                         [0, 0, -1],
        #         #                         [0, 1, 0]])*xyz[i].T)
        #         # print(np.dot(np.array([[1, 0, 0],
        #         #                         [0, 0, -1],
        #         #                         [0, 1, 0]]), xyz[i]))
        #         # sdf
        #         # xyz_new.append(np.dot(np.array([[1, 0, 0],
        #         #                                 [0, 0, -1],
        #         #                                 [0, 1, 0]]), xyz[i]))
        #         xyz_new.append(xyz[i])
        #         normals_new.append(normals[i])
        #         f_dc_new.append(f_dc[i])
        #         f_rest_new.append(f_rest[i])
        #         opacities_new.append(opacities[i])
        #         scale_new.append(scale[i])
        #         # rotation_new.append(rotation[i])
        #         rotation_new.append(np.array([0, 0, 0, 1]))

        # # print(sum)
        # attributes = np.concatenate((xyz_new, normals_new, f_dc_new, f_rest_new, opacities_new, scale_new, rotation_new), axis=1)
        #     # print(xyz_point[i])
        #     # sdf
        # elements = np.empty(len(xyz_new), dtype=dtype_full)
